...
const RestuarentList = () => {
    ...
    <div className="mx-2">
      <div className="ml-2 my-6">
        ...
        <button onClick={searchRes} className="text-[18px] rounded-r-xl p-2 shadow-md  font-medium">Search</button>
        <button className="text-[18px] rounded-xl p-2 ml-5 shadow-md  font-medium">Filter</button>
      </div>
      <div className="grid grid-cols-[repeat(auto-fit,minmax(400px,1fr))] gap-5">
      {
        (inputVal ? itemsCopy: items).map((restuarant)=>(
